 ...
 */
OutputMotorToSerial* gOutputMotorHandler;

void OutputMotorToSerial::staticCallbackBase( const boost::shared_ptr<alfred_msg::DriveBase const>& msg){
   gOutputMotorHandler->callbackBase(msg);
}
